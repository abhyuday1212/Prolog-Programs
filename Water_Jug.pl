...
(X=:=3, Y=:=0,nl, write('4L:33L:3 (Action: Fill 3L jug.)'), YY is 3, water_jug(X, YY));
...
(X=:=4, Y=:=1,nl,write('4L:2 & 3L:3 (Action: Pour water from 4L jug to 3L jug until 3L jug is full.)'),XX is X-2, YY is Y+2,
 water_jug(XX, YY));
